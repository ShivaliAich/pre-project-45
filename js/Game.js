class Game{
    ...
    readGameState(){
      ...
      player3.addImage("player3",hp3IMG);
        player3.scale = 0.4;
        player3.debug = false;
        player3.setCollider("rectangle",10,10,100,500);
      player4 = createSprite(1200,500);
      player4.addImage("player4", hp4IMG);
      player4.scale = 0.4;
      player4.debug = false;
      player4.setCollider("rectangle",10,10,100,500);
     players =[player1,player2,player3,player4];
      ...
      play(){
        ...
        var y=500;
        var index =0;
        fill(rgb(118,233,255));
        textSize(30);
        textFont("Georgia");
        text("Look out! Here come the dragons and hippogriffs!",500,100);
        for(var plr in allPlayers){
          ...
          fill("white");
          textSize(25);
          text(allPlayers[plr].name ,x-25,y-140);
        }
        //fill("white");
        ...
        /*textSize(25); 
        fill("white"); 
        text("Player 1 :" +player1.score,20,100); 
        text("Player 2 :" +player2.score,20,150);*/ 
        ...
        switch(rand){
          ...
          if (player.index !== null) {
            ...
            for (var i = 0; i < pointsGroup.length; i++) { 
              ...
              text("Player 1 :" +player1.score,20,100); 
              text("Player 2 :" +player2.score,20,150);
              text("Player 3 :" +player3.score,20,200); 
              text("Player 4 :" +player4.score,20,250);
            }
